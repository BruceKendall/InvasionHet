...
## Data munging
Realizing that I need to re-use the `seedlings1` data from last time, I see that I should start to use the `munge` directory for key derived data. I therefore ned to give it a more meaningful name; how about `Ler_eff_seeds_gen1`.

The code for doing this is in `munge/01-Ler-eff-seed-gen1.R`
